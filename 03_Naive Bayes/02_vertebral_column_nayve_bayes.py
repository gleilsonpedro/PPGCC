...
# Inicializar e treinar o classificador Naive Bayes para a realização mais próxima da média
naive_bayes_proximo_media = NaiveBayes()
naive_bayes_proximo_media.fit(X_train_naive_bayes[:, :2], y_train_naive_bayes)
y_pred_naive_bayes_proximo_media = naive_bayes_proximo_media.predict(X_test_naive_bayes[:, :2])
