...
print("\nMatriz de Confusão para KNN (Realização mais próxima da média):")
...
print("Melhor Acurácia e Desvio Padrão do Gaussian NB (Bayesiano):")
...
print("Melhor Realização para Gaussian NB (Bayesiano) (baseada na acurácia mais próxima da média):", indice_realizacao_proxima_media_bayes)
...
print("Matriz de Confusão para Gaussian NB (Bayesiano) (Realização mais próxima da média):")
...
plt.title('Conjunto de Dados Breast Cancer - Distribuição das Classes e Pontos de Treinamento/Teste')
plt.xlabel('Feature 1')
plt.ylabel('Feature 2')
plt.legend()
plt.show()
